...
| ------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `autoCancelAfterFailures` | _number_ &#124 _false_ | Specify the number of failures to cancel a run being recorded to the Cloud or false to disable auto-cancellation.                                                  |
...
| Version                                       | Changes                                                 |
| --------------------------------------------- | ------------------------------------------------------- |
| [12.6.0](/guides/references/changelog#12-6-0) | Added `autoCancelAfterFailures` to run options.         |
